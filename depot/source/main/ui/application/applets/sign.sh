...
$JAVA_HOME/bin/jarsigner -verbose -keystore appkeystore -storepass pa55123 -keypass pa55123 -signedjar SignedApplet.0.1.jar build/jar/applets.jar signFiles
cp -f -v SignedApplet.0.2.jar ../../public/dist/
